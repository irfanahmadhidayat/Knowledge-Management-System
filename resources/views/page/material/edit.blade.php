                    ...
                    <form action="{{ route('material.update', $material->id) }}" method="POST"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="material_name" id="material_name"
                                ...
                                placeholder="Enter material_name">
                            @error('material_name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="material_description" id="material_description"
                                ...
                                placeholder="Masukkan deskripsi materi">{{ old('material_description', $material->material_description) }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            ...
                            @if ($material->file_path)
                                <p>File saat ini:
                                    <a href="{{ asset('storage/' . $material->file_path) }}" target="_blank">Lihat File</a>
                                </p>
                            @endif
                            @error('file')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="role_id" id="role_id"
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{ $role->id }}" @if ($role->id == $material->role_id) selected @endif>
                                        {{ ucfirst($role->name) }}
                                    </option>
                                @endforeach
                            </select>
